...
$scope.$declarePoperty = function (valKey, value) {
	this.$permitted = this.$permitted || {}
	this.$permitted[valKey] = value

	Object.defineProperty(this, valKey, {
		get: function () {
			return this.$permitted[valKey]
		},
		set: function (_val) {
			if(_val === this.$permitted[valKey]) {
				return
			}

			this.$permitted[valKey] = _val
