 ...
 * @author nd
 **/
Scope.prototype.$declareProperties = function (d) {
  for (var n in d) {
 ...
 * @author nd
 **/
Scope.prototype.$declareProperty = function (prop, value) {
  var scope = this
 ...
 * @author nd
 **/
Scope.prototype.$declareAccessor = function (valKey, value) {
 ...
 * @author nd
 **/
Scope.prototype.$declareRelator = function (valKey, relation) {
  Object.defineProperty(this, valKey, {
    get: function () {
 ...
 * @author nd
 **/
Scope.prototype.$pset = function (key, value) {
 ...
 * @author nd
 **/
Scope.prototype.$pget = function (key) {
 ...
 * @author nd
 **/
Scope.prototype.$get = function (qKey) {
 ...
 * @author nd
 **/
Scope.prototype.$set = function (qKey, value) {
  var parts = qKey.trim().split('.')
  var key = parts.pop()
  var parent = this
 ...
 * @author nd
 **/
Scope.prototype.$triggerUpdate = function (qKey) {
